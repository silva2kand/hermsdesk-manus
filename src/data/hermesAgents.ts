...
export const hermesAgents: HermesAgent[] = [
  ...
  },
  {
    ...
    group: 'Hermes',
    role: 'Real PC Operator & Browser Automation',
    capability: 'Controls the host computer and browser: open apps, manage windows, click/type/extract, and verify steps across the entire system.',
    connector: 'Browser Operator, OS Control, TinyFish, Web Research',
