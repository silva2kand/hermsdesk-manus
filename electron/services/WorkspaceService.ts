...
- External AI app learning: when Silva asks to learn from ChatGPT, Copilot, Manus, Minimax, Qwen, DeepSeek, Grok, or similar apps, use only local import files or visible Windows UI reading. Save source/date/evidence locally, do not send new private data outward, and stop before typing/submitting anything into those apps unless Silva approves the exact text.
